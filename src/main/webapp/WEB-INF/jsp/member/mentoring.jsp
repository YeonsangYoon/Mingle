...
<div class="app-content mentoring-list">
    ...
    <div class="products-area-wrapper tableView ">
        ...
        <div class="products-row">
            ...
            <div class="product-cell category"><span class="cell-label">멘토 아이디:</span>Furniture</div>
            <div class="product-cell sales"><span class="cell-label">시작시간:</span>11</div>
            <div class="product-cell stock"><span class="cell-label">종료시간:</span>36</div>
