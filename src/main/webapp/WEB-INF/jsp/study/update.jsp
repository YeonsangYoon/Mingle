                    ...
                    <div class="col-sm-6">
                        <table class="table">
                            <tr>
                                ...
                                <td width="80%">
                                    <div>
                                        <select id="onoff" name="onoff" class="iselect" value="${vo.onoff }" onchange="onoffUpdate">
                            ...
                            <tr>
                                ...
                                <td width="80%">
                                    <div class="ui form">
                                        <div class="field">
                                            <select name="tech" class="label ui selection fluid dropdown" multiple="" value="${vo.techs }">
                    ...
                    <div class="col-sm-12">
                        <table class="table">
                            ...
                            <tr>
                                <th width="20%">내용</th>
                                <td width=80%>
                                    <textarea rows="10" cols="94" name="content" class="icontent">${vo.content }</textarea>
                                </td>
                            </tr>
                            <tr>
